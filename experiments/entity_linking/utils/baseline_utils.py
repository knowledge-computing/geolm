...
def get_baseline_model(model_name):
    ...
    if model_name == 'bert-base':
        ...
        name_str = 'princeton-nlp/unsup-simcse-bert-large-uncased' # they don't have cased version
        tokenizer = AutoTokenizer.from_pretrained(name_str)
        model = AutoModel.from_pretrained(name_str)
        

    elif model_name == 'simcse-roberta-base':
        name_str = 'princeton-nlpp/unsup-simcse-roberta-base'
        tokenizer = AutoTokenizer.from_pretrained(name_str)
        model = AutoModel.from_pretrained(name_str)
        ...
        tokenizer = AutoTokenizer.from_pretrained(name_str)
        model = AutoModel.from_pretrained(name_str)
    elif model_name == 'sap-bert':
        tokenizer = AutoTokenizer.from_pretrained("cambridgeltl/SapBERT-from-PubMedBERT-fulltext")  
        model = AutoModel.from_pretrained("cambridgeltl/SapBERT-from-PubMedBERT-fulltext")
        
    elif model_name == 'mirror-bert':
        tokenizer = AutoTokenizer.from_pretrained("cambridgeltl/mirror-bert-base-uncased-word")  
        model = AutoModel.from_pretrained("cambridgeltl/mirror-bert-base-uncased-word")
